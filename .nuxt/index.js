...
import nuxt_plugin_plugin_20b36d26 from 'nuxt_plugin_plugin_20b36d26' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_6954f92a from 'nuxt_plugin_bootstrapvue_6954f92a' // Source: ./bootstrap-vue.js (mode: 'all')
import nuxt_plugin_axios_6ce3a13c from 'nuxt_plugin_axios_6ce3a13c' // Source: ./axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"龍洞岬","titleTemplate":"龍洞岬","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_20b36d26 === 'function') {
    await nuxt_plugin_plugin_20b36d26(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_6954f92a === 'function') {
    await nuxt_plugin_bootstrapvue_6954f92a(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_6ce3a13c === 'function') {
    await nuxt_plugin_axios_6ce3a13c(app.context, inject)
  }
