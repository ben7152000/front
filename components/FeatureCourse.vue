<template>
  <div class="section-padding-t90-b100">
    <div class="container">
      <SectionTitle title="自 由 潛 水 AIDA 課 程"
    ...
    return {
      features: [
        ...
        },
        {
          title: "AIDA 2 課程",
          text:
            "課程將針對自由潛水初學者正式進入開放海域所設計的基礎課程建立安全潛水的基本知識與能力。所有自由潛水的進步方式，練習技巧，基礎海況分析...等，都將在課堂中一一傳授與講解。",
          image: "/images/aida-2.png",
          url: "/course-aida-2",
          price: "13500 TWD",
          day: "3 天"
        },
